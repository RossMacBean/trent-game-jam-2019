...
public class CableComponent : MonoBehaviour
{
	...
	private Vector3 m_EndPointVector = Vector3.zero;

	public Transform EndPoint => endPoint;
	public Vector3 EndPointVector => EndPointVector;
	...
	public void SetEndPoint(Transform NewEndPoint)
	{
		...
		m_EndPointVector = endPoint.position;
	...
	public void SetEndPointVector(Vector3 NewEndPointVector)
	{
		m_EndPointVector = NewEndPointVector;
